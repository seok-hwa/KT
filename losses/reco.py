...
class CriterionCustom(nn.Module):
    ...
    def forward(self, preds_S, preds_T):
        ...
        if self.divergence == 'kl':
            ...
            norm_s = preds_S.reshape(n, c, -1)
            norm_t = preds_T.reshape(n, c, -1).detach()
