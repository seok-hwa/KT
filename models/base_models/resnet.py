...
__all__ = ['ResNetV1b', 'resnet18_v1b', 'resnet50_v1b',
           'resnet101_v1b', 'resnet18_v1s', 'resnet50_v1s', 'resnet101_v1s', 'resnet152_v1s']
...
# def resnet152_v1s(pretrained=False, local_rank=None, **kwargs):
...
def resnet152_v1s(pretrained=False, local_rank=None, **kwargs):
    ...
    for k in old_dict:
        if k in model_dict:
            if old_dict[k].shape != model_dict[k].shape:
                old_dict[k] = model_dict[k]
