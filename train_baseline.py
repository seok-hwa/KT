...
def parse_args():
    ...
    parser.add_argument('--log-dir', default='../runs/logs/',
                        help='Directory for saving checkpoint models')
    parser.add_argument('--log-iter', type=int, default=40,
    ...
    def __init__(self, args):
        ...
        with torch.no_grad():
            logger.info('Params: %.2fM FLOPs: %.2fG'
                % (cal_param_size(self.model) / 1e6, cal_multi_adds(self.model, (1, 3, 512, 1024))/1e9))
...
def save_checkpoint(model, args, is_best=False):
    ...
    filename = 'baseline_{}_{}_{}.pth'.format(args.model, args.backbone, args.dataset)
    ...
    if is_best:
        best_filename = 'baseline_{}_{}_{}_best_model.pth'.format(args.model, args.backbone, args.dataset)
...
if __name__ == '__main__':
    ...
    logger = setup_logger("semantic_segmentation", args.log_dir, get_rank(), filename='baseline_{}_{}_{}_log.txt'.format(
